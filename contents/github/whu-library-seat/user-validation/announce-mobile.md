...
<a target="_blank" href="https://github.com/CS-Tao/whu-library-seat-mobile/releases/tag/v1.7.4">移动端 v1.7.4 更新日志</a>
...
- 本软件为图书馆抢座软件移动版，是原桌面端软件的衍生版本，布局和样式可能和一些设备不太兼容
